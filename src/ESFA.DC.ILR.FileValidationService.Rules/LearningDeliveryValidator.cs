...
namespace ESFA.DC.ILR.FileValidationService.Rules
{
    ...
    {
        public LearningDeliveryValidator(IValidator<ILooseLearningDeliveryFAM> learningDeliveryFAMValidator, IValidator<ILooseAppFinRecord> appFinRecordValidator)
        {
