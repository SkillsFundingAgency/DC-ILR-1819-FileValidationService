    ...
    public class LearnerMapper : AbstractModelMapper<Loose.MessageLearner, MessageLearner>
    {
        ...
        protected override MessageLearner MapModel(Loose.MessageLearner model)
        {
            return new MessageLearner()
            {
                ...
                AddLine1 = model.AddLine1.Sanitize(),
                AddLine2 = model.AddLine2.Sanitize(),
                AddLine3 = model.AddLine3.Sanitize(),
                AddLine4 = model.AddLine4.Sanitize(),
                ALSCost = (int)model.ALSCost,
                ALSCostSpecified = model.ALSCostSpecified,
                CampId = model.CampId.Sanitize(),
                ...
                Email = model.Email.Sanitize(),
                EngGrade = model.EngGrade.Sanitize(),
                Ethnicity = (int)model.Ethnicity,
                FamilyName = model.FamilyName.Sanitize(),
                GivenNames = model.GivenNames.Sanitize(),
                ...
                NINumber = model.NINumber.Sanitize(),
                ...
                PrevLearnRefNumber = model.PrevLearnRefNumber.Sanitize(),
                ...
                Sex = model.Sex.Sanitize(),
                TelNo = model.TelNo.Sanitize(),
                ULN = model.ULN,
            };
        }
    }
